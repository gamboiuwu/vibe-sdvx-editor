...
export const I18N = {
  ...
  fr: {
    ...
    'preview.rate': 'Cadence', 'preview.judgeY': 'Ligne Y', 'preview.loop': 'Boucle', 'preview.metronome': 'Métronome', 'preview.scroll': 'Défilement', 'preview.mods': 'Mods', 'preview.reaction': 'Green#', 'preview.setHispeed': 'Régler', 'preview.sudden': 'Sudden+', 'preview.hidden': 'Hidden+', 'preview.multiChart': 'Multi-graphique', 'preview.more': 'Plus',
  ...
  ja: {
    ...
    'preview.rate': '再生速度', 'preview.judgeY': '判定Y', 'preview.loop': 'ループ', 'preview.metronome': 'メトロノーム', 'preview.scroll': 'スクロール', 'preview.mods': 'モッド', 'preview.reaction': '緑数字', 'preview.setHispeed': '設定', 'preview.sudden': 'サドン+', 'preview.hidden': 'ヒドゥン+', 'preview.multiChart': 'マルチ譜面', 'preview.more': '詳細',
  ...
  zh: {
    ...
    'preview.rate': '倍速', 'preview.judgeY': '判定线Y', 'preview.loop': '循环', 'preview.metronome': '节拍器', 'preview.scroll': '滚动', 'preview.mods': '修改器', 'preview.reaction': '绿数字', 'preview.setHispeed': '设置', 'preview.sudden': '顶部遮罩', 'preview.hidden': '底部遮罩', 'preview.multiChart': '多谱面', 'preview.more': '更多',
