...
export const I18N = {
  ...
  ja: {
    ...
    'preview.rate': '再生速度', 'preview.judgeY': '判定Y', 'preview.loop': 'ループ', 'preview.metronome': 'メトロノーム', 'preview.scroll': 'スクロール', 'preview.mods': 'モッド', 'preview.reaction': '緑数字', 'preview.greenTarget': '→ms', 'preview.greenTargetPh': '設定', 'preview.crefBpm': '自動', 'preview.soflan': 'ソフラン', 'preview.greenFollow': '固定', 'preview.reactionCover': 'カバー適用時の反応ウィンドウ', 'preview.sudden': 'サドン+', 'preview.hidden': 'ヒドゥン+', 'preview.lift': 'LIFT', 'preview.multiChart': 'マルチ譜面', 'preview.more': '詳細',
  ...
  zh: {
    ...
    'preview.rate': '倍速', 'preview.judgeY': '判定线Y', 'preview.loop': '循环', 'preview.metronome': '节拍器', 'preview.scroll': '滚动', 'preview.mods': '修改器', 'preview.reaction': '绿数字', 'preview.greenTarget': '→ms', 'preview.greenTargetPh': '设置', 'preview.crefBpm': '自动', 'preview.soflan': '变速', 'preview.greenFollow': '锁定', 'preview.reactionCover': '遮罩后的反应窗口', 'preview.sudden': '顶部遮罩', 'preview.hidden': '底部遮罩', 'preview.lift': 'LIFT', 'preview.multiChart': '多谱面', 'preview.more': '更多',
