...
export const I18N = {
  en: {
    ...
    'preview.stripTipMeasure': 'Measure',
    'preview.stripTipReact':   'react',
    'preview.stripTipHardest': 'hardest',
    'preview.density':       'Density',
    'preview.nps':           'NPS',
    'preview.npsTip':        'Peak notes-per-second',
    'preview.hand':          'Hand',
    'preview.handTip':       'Hand balance',
    'preview.handTipEmpty':  'Hand balance: no BT/FX notes in this chart.',
    ...
    'preview.lift':       'LIFT',
    'preview.coverTarget': 'Cover →ms',
    'preview.coverSolve': 'Solve',
    'preview.coverUnreachable': 'Cover alone reaches {ms} ms — {hint}',
    'preview.greenUnreachable': 'HiSpeed alone reaches {ms} ms — {hint}',
    'preview.fitToRange': 'Fit',
    'preview.fitToRangeTitle': 'Set the target to {ms} ms — the nearest reachable reading window — and re-solve',
    'preview.coverGuard': '{pct}% lane visible',
    'preview.coverGuardTitle': 'Sudden+/Hidden+/LIFT together cover {total}% of the runway — only {pct}% is visible. The reading strip is very small.',
  ...
  es: {
    ...
    'preview.nps':           'NPS',
    'preview.npsTip':        'Notas por segundo pico',
    'preview.hand':          'Mano',
    'preview.handTip':       'Equilibrio de manos',
    'preview.handTipEmpty':  'Equilibrio de manos: no hay notas BT/FX en esta partitura.',
    'preview.stripTipMeasure': 'Compás',
    'preview.stripTipReact':   'reac.',
    'preview.stripTipHardest': 'más difícil',
    'preview.greenTarget':   '→ms',
    'preview.greenTargetPh': 'set',
    'preview.crefBpm':    'auto',
    'preview.soflan':     'Soflan',
    ...
    'preview.hidden':     'Hidden+',
    'preview.lift':       'LIFT',
    'preview.coverTarget': 'Cubierta →ms',
    'preview.coverSolve': 'Resolver',
    'preview.coverUnreachable': 'Solo la cubierta llega a {ms} ms — {hint}',
    'preview.greenUnreachable': 'Solo la velocidad llega a {ms} ms — {hint}',
    'preview.fitToRange': 'Ajustar',
    'preview.fitToRangeTitle': 'Fija el objetivo en {ms} ms — la ventana de lectura alcanzable más cercana — y recalcula',
    'preview.coverGuard': '{pct}% de pista visible',
    'preview.coverGuardTitle': 'Sudden+/Hidden+/LIFT cubren juntos el {total}% de la pista — solo se ve el {pct}%. La franja de lectura es muy pequeña.',
