...
export const I18N = {
  en: {
    ...
    'preview.soflanAll':  'All',
    'preview.soflanThin': 'Thin',
    'preview.soflanNet':  'Net',
  ...
  es: {
    ...
    'preview.crefBpm':    'auto',
    'preview.soflan':     'Soflan',
    'preview.soflanAll':  'Todos',
    'preview.soflanThin': 'Reducir',
    'preview.soflanNet':  'Neto',
    'preview.greenFollow': 'Hold',
  ...
  fr: {
    ...
    'preview.rate': 'Cadence', 'preview.judgeY': 'Ligne Y', 'preview.loop': 'Boucle', 'preview.metronome': 'Métronome', 'preview.scroll': 'Défilement', 'preview.mods': 'Mods', 'preview.reaction': 'Green#', 'preview.greenTarget': '→ms', 'preview.greenTargetPh': 'régl', 'preview.crefBpm': 'auto', 'preview.soflan': 'Soflan', 'preview.soflanAll': 'Tous', 'preview.soflanThin': 'Réduire', 'preview.soflanNet': 'Net', 'preview.greenFollow': 'Hold', 'preview.reactionCover': 'Fenêtre de réaction ajustée au cache', 'preview.sudden': 'Sudden+', 'preview.hidden': 'Hidden+', 'preview.lift': 'LIFT', 'preview.coverTarget': 'Cache →ms', 'preview.coverSolve': 'Résoudre', 'preview.multiChart': 'Multi-graphique', 'preview.more': 'Plus',
  ...
  ja: {
    ...
    'preview.rate': '再生速度', 'preview.judgeY': '判定Y', 'preview.loop': 'ループ', 'preview.metronome': 'メトロノーム', 'preview.scroll': 'スクロール', 'preview.mods': 'モッド', 'preview.reaction': '緑数字', 'preview.greenTarget': '→ms', 'preview.greenTargetPh': '設定', 'preview.crefBpm': '自動', 'preview.soflan': 'ソフラン', 'preview.soflanAll': '全て', 'preview.soflanThin': '間引き', 'preview.soflanNet': '正味', 'preview.greenFollow': '固定', 'preview.reactionCover': 'カバー適用時の反応ウィンドウ', 'preview.sudden': 'サドン+', 'preview.hidden': 'ヒドゥン+', 'preview.lift': 'リフト', 'preview.coverTarget': 'カバー →ms', 'preview.coverSolve': '計算', 'preview.multiChart': 'マルチ譜面', 'preview.more': '詳細',
  ...
  zh: {
    ...
    'preview.rate': '倍速', 'preview.judgeY': '判定线Y', 'preview.loop': '循环', 'preview.metronome': '节拍器', 'preview.scroll': '滚动', 'preview.mods': '修改器', 'preview.reaction': '绿数字', 'preview.greenTarget': '→ms', 'preview.greenTargetPh': '设置', 'preview.crefBpm': '自动', 'preview.soflan': '变速', 'preview.soflanAll': '全部', 'preview.soflanThin': '稀疏', 'preview.soflanNet': '净变', 'preview.greenFollow': '锁定', 'preview.reactionCover': '遮罩后的反应窗口', 'preview.sudden': '顶部遮罩', 'preview.hidden': '底部遮罩', 'preview.lift': '判定线上移', 'preview.coverTarget': '遮罩 →ms', 'preview.coverSolve': '求解', 'preview.multiChart': '多谱面', 'preview.more': '更多',
