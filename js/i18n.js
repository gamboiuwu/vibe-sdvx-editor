...
export const I18N = {
  ...
  ja: {
    ...
    'preview.rate': '再生速度', 'preview.judgeY': '判定Y', 'preview.loop': 'ループ', 'preview.metronome': 'メトロノーム', 'preview.scroll': 'スクロール', 'preview.mods': 'モッド', 'preview.reaction': '緑数字', 'preview.reactionRange': '範囲', 'preview.greenTarget': '→ms', 'preview.greenTargetPh': '設定', 'preview.crefBpm': '自動', 'preview.soflan': 'ソフラン', 'preview.greenFollow': '固定', 'preview.reactionCover': 'カバー適用時の反応ウィンドウ', 'preview.sudden': 'サドン+', 'preview.hidden': 'ヒドゥン+', 'preview.lift': 'リフト', 'preview.coverTarget': 'カバー →ms', 'preview.coverSolve': '計算', 'preview.coverUnreachable': 'カバーのみでは {ms} ms まで — {hint}', 'preview.greenUnreachable': 'ハイスピードのみでは {ms} ms まで — {hint}', 'preview.fitToRange': '合わせる', 'preview.fitToRangeTitle': 'ターゲットを到達可能な最も近い読みウィンドウ {ms} ms に設定して再計算', 'preview.coverGuard': 'レーン表示 {pct}%', 'preview.coverGuardTitle': 'サドン+/ヒドゥン+/リフトの合計でレーンの{total}%を覆い、見えるのは{pct}%だけです。読める帯が非常に狭くなっています。', 'preview.multiChart': 'マルチ譜面', 'preview.more': '詳細',
  ...
  zh: {
    ...
    'preview.rate': '倍速', 'preview.judgeY': '判定线Y', 'preview.loop': '循环', 'preview.metronome': '节拍器', 'preview.scroll': '滚动', 'preview.mods': '修改器', 'preview.reaction': '绿数字', 'preview.reactionRange': '范围', 'preview.greenTarget': '→ms', 'preview.greenTargetPh': '设置', 'preview.crefBpm': '自动', 'preview.soflan': '变速', 'preview.greenFollow': '锁定', 'preview.reactionCover': '遮罩后的反应窗口', 'preview.sudden': '顶部遮罩', 'preview.hidden': '底部遮罩', 'preview.lift': '判定线上移', 'preview.coverTarget': '遮罩 →ms', 'preview.coverSolve': '求解', 'preview.coverUnreachable': '仅靠遮罩只能达到 {ms} ms — {hint}', 'preview.greenUnreachable': '仅靠速度只能达到 {ms} ms — {hint}', 'preview.fitToRange': '适配', 'preview.fitToRangeTitle': '将目标设为最接近的可达阅读窗口 {ms} ms 并重新求解', 'preview.coverGuard': '轨道可见 {pct}%', 'preview.coverGuardTitle': '顶部遮罩/底部遮罩/判定线上移合计遮住轨道 {total}%，仅剩 {pct}% 可见。可读区域非常小。', 'preview.multiChart': '多谱面', 'preview.more': '更多',
