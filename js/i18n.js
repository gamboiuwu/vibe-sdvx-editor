...
export const I18N = {
  en: {
    ...
    'insertTime.title':   'Insert Time',
    'insertTime.help':    'Open a blank gap, pushing everything from the insert point onward later in time. Holds and lasers crossing the point stretch across the gap.',
    'insertTime.amount':  'Amount',
    'insertTime.measures':'Measures',
    'insertTime.beats':   'Beats',
    'insertTime.at':      'Insert at',
    'insertTime.atPlayhead': 'Playhead',
    'insertTime.atSelection':'Selection start',
    'insertTime.ok':      'Insert',
  ...
  es: {
    ...
    'edit.insertTime': 'Insertar tiempo…',
    'insertTime.title': 'Insertar tiempo',
    'insertTime.help': 'Abre un hueco en blanco, desplazando todo lo posterior al punto de inserción. Las notas mantenidas y los láseres que lo cruzan se estiran sobre el hueco.',
    'insertTime.amount': 'Cantidad', 'insertTime.measures': 'Compases', 'insertTime.beats': 'Tiempos',
    'insertTime.at': 'Insertar en', 'insertTime.atPlayhead': 'Cursor', 'insertTime.atSelection': 'Inicio de selección',
    'insertTime.ok': 'Insertar', 'common.cancel': 'Cancelar',
  ...
  fr: {
    ...
    'edit.insertTime': 'Insérer du temps…',
    'insertTime.title': 'Insérer du temps',
    'insertTime.help': 'Ouvre un espace vide en décalant tout ce qui suit le point d’insertion. Les tenues et les lasers qui le traversent s’étirent sur l’espace.',
    'insertTime.amount': 'Quantité', 'insertTime.measures': 'Mesures', 'insertTime.beats': 'Temps',
    'insertTime.at': 'Insérer à', 'insertTime.atPlayhead': 'Tête de lecture', 'insertTime.atSelection': 'Début de sélection',
    'insertTime.ok': 'Insérer', 'common.cancel': 'Annuler',
  ...
  ja: {
    ...
    'edit.insertTime': '時間を挿入…',
    'insertTime.title': '時間を挿入',
    'insertTime.help': '空白の間隔を挿入し、挿入位置以降のすべてを後ろにずらします。挿入点をまたぐホールドやレーザーは間隔を越えて引き伸ばされます。',
    'insertTime.amount': '量', 'insertTime.measures': '小節', 'insertTime.beats': '拍',
    'insertTime.at': '挿入位置', 'insertTime.atPlayhead': '再生位置', 'insertTime.atSelection': '選択範囲の先頭',
    'insertTime.ok': '挿入', 'common.cancel': 'キャンセル',
  ...
  zh: {
    ...
    'edit.insertTime': '插入时间…',
    'insertTime.title': '插入时间',
    'insertTime.help': '打开一段空白间隔，将插入点之后的所有内容向后推移。跨越插入点的长按和激光会被拉伸以横跨该间隔。',
    'insertTime.amount': '数量', 'insertTime.measures': '小节', 'insertTime.beats': '拍',
    'insertTime.at': '插入位置', 'insertTime.atPlayhead': '播放头', 'insertTime.atSelection': '选区起点',
    'insertTime.ok': '插入', 'common.cancel': '取消',
